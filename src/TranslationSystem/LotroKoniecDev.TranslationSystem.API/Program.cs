...
try
{
    ...
    // with X-Forwarded-* headers. Honour them so Request.Scheme is https, which keeps the JWT
    // issuer, HATEOAS hrefs, Secure cookies, and UseHttpsRedirection correct.
    //
