...
/// metered on <c>Connection.RemoteIpAddress</c>: a direct caller, a wrong or missing key, and a
/// missing, repeated or broken address. <c>UseForwardedHeaders</c> resolved that address from Caddy's
