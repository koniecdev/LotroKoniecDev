...
echo ""
echo "Next: scripts/up-prod.sh maps the *.lotro.test vhosts to loopback automatically (one-time, needs admin)."
echo "  (manual equivalent: add '127.0.0.1 app.lotro.test auth.lotro.test tms.lotro.test' to your hosts file)"
