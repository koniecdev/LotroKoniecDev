...
/// and removal state (dead transitions are never advertised).
/// </summary>
internal interface ITranslationAggregateLinkFactory
{
    ...
    List<LinkDto> CreateTranslationLinks(TranslationId id, TranslationStatus status, bool isRemoved, bool callerIsAdmin);
}
